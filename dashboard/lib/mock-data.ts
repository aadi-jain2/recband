...
const _RAW_REGISTRY = [
  { id:"P001", name:"James Washington",   age:72, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-26", numMedications:14, numDiagnoses:8, numPriorAdmissions:2, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P002", name:"María González",    age:68, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-24", numMedications:11, numDiagnoses:7, numPriorAdmissions:1, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P003", name:"Wei Chen",          age:77, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-27", numMedications:16, numDiagnoses:9, numPriorAdmissions:3, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P004", name:"Patricia Johnson",  age:64, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-21", numMedications:10, numDiagnoses:5, numPriorAdmissions:1, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P005", name:"Carlos Rivera",     age:71, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-23", numMedications:12, numDiagnoses:6, numPriorAdmissions:2, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P006", name:"Margaret O'Brien",  age:59, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-18", numMedications:9,  numDiagnoses:7, numPriorAdmissions:1, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P007", name:"Omar Hassan",       age:66, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-25", numMedications:13, numDiagnoses:8, numPriorAdmissions:2, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P008", name:"Elena Morales",     age:74, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-22", numMedications:10, numDiagnoses:6, numPriorAdmissions:1, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P009", name:"Marcus Williams",   age:58, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-16", numMedications:8,  numDiagnoses:4, numPriorAdmissions:0, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P010", name:"Yuki Tanaka",       age:62, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-19", numMedications:7,  numDiagnoses:4, numPriorAdmissions:0, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P011", name:"Stefan Mueller",    age:55, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-14", numMedications:9,  numDiagnoses:5, numPriorAdmissions:1, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P012", name:"Fatima Al-Rashid",  age:67, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-11", numMedications:11, numDiagnoses:7, numPriorAdmissions:2, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P013", name:"Claire Dubois",     age:70, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-17", numMedications:9,  numDiagnoses:5, numPriorAdmissions:1, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P014", name:"Nguyen Van Duc",    age:63, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-12", numMedications:6,  numDiagnoses:4, numPriorAdmissions:0, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P015", name:"Rosa Santos",       age:56, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-09", numMedications:8,  numDiagnoses:5, numPriorAdmissions:0, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P016", name:"Min-jun Park",      age:48, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-20", numMedications:7,  numDiagnoses:4, numPriorAdmissions:0, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P017", name:"Thomas Clarke",     age:61, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-08", numMedications:10, numDiagnoses:6, numPriorAdmissions:1, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P018", name:"Linda Bergstrom",   age:69, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-13", numMedications:8,  numDiagnoses:5, numPriorAdmissions:0, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P019", name:"Andre Thompson",    age:52, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-06", numMedications:6,  numDiagnoses:3, numPriorAdmissions:0, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P020", name:"Sophie Laurent",    age:57, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-10", numMedications:5,  numDiagnoses:3, numPriorAdmissions:0, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P021", name:"David Okonkwo",     age:44, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-04", numMedications:7,  numDiagnoses:3, numPriorAdmissions:0, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P022", name:"Rebecca Stone",     age:60, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-07", numMedications:9,  numDiagnoses:5, numPriorAdmissions:1, diabetesFlag:false, copdFlag:true,  chfFlag:false },
  { id:"P023", name:"Miguel Torres",     age:49, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-02", numMedications:6,  numDiagnoses:3, numPriorAdmissions:0, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P024", name:"Arjun Sharma",      age:65, diagnosis:"CHF",  diagnosisCode:"I50.0", dischargeDate:"2026-06-05", numMedications:10, numDiagnoses:6, numPriorAdmissions:1, diabetesFlag:false, copdFlag:false, chfFlag:true  },
  { id:"P025", name:"Kavitha Nair",      age:53, diagnosis:"COPD", diagnosisCode:"J44.1", dischargeDate:"2026-06-03", numMedications:8,  numDiagnoses:4, numPriorAdmissions:0, diabetesFlag:false, copdFlag:true,  chfFlag:false },
]
